...
const sections = [
  ...
  },
  {
    ...
    content: `We collect the following data types to provide our Vedic wellness services:
    
• Contact Info: Your email address (managed via Clerk) for account security and updates.
• Identifiers: Unique user IDs generated by Clerk and internal database IDs.
• Sensitive Data: Birth details (Date, Time, Location) used exclusively for Vedic calculations.
• Wellness Data: Information shared during AI consultations (VAIDYA) and Dosha quiz responses.
• Diagnostics: Anonymous performance logs and crash reports to ensure app stability.

Conversations are stored in our secure database to provide continuity across your devices (Premium) or held locally for Free tier users.`,
  },
  {
