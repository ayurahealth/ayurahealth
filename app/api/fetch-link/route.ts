...
export async function POST(req: NextRequest) {
  try {
    ...
    // Use custom fetchWithSSRFProtection to prevent SSRF vulnerabilities and DNS rebinding attacks.
    // Native fetch lacks protections against querying internal network IPs.
