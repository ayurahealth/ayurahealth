...
const ConnectionLines = () => {
  // ⚡ Bolt: Memoize the fully constructed Float32Array and args array to avoid WebGL buffer reallocation on every render.
  // We also avoid creating intermediate THREE.Vector3 objects to reduce memory allocation and GC overhead.
