...
export default function HolographicLabMap({ results = [] }: Props) {
  ...
  // What: Pre-process results array into a Map/Record.
  // Why: Avoids O(N x M) nested lookups using `.find()` inside the map loop.
  // Impact: Improves frame rates by turning O(N x M) operations into O(N) operations.
