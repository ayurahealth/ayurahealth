...
const ConnectionLines = () => {
  const positions = useMemo(() => {
    // ⚡ Bolt: Push primitive coordinates directly to avoid intermediate THREE.Vector3 creation
    // and memoize the final Float32Array to prevent costly WebGL buffer reallocation on every render.
    const p: number[] = []
