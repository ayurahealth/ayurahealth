...
const ConnectionLines = () => {
  // ⚡ Bolt: Prevent intermediate object creation (Vector3) and WebGL buffer reallocation on every render
  // by directly building and memoizing the flat Float32Array for the bufferAttribute args.
