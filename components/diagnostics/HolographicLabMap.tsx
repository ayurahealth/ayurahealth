...
const ConnectionLines = () => {
  // ⚡ Bolt: Memoize the final Float32Array to prevent WebGL buffer reallocation on every render,
  // and directly push primitive coordinates to avoid allocating intermediate THREE.Vector3 objects.
