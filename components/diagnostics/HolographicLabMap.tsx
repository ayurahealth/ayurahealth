...
export default function HolographicLabMap({ results = [] }: Props) {
  ...
  // Convert results array to a Record for O(1) lookups.
  // This prevents an O(N x M) bottleneck when mapping over BIOMARKER_MAP
  // and using .find() on results inside the render loop.
