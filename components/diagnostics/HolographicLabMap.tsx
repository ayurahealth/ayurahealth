...
const ConnectionLines = () => {
  // ⚡ Bolt: Memoize the typed array entirely to prevent R3F from destroying
  // and re-allocating the WebGL bufferAttribute on every parent hover render.
  // We also avoid O(N^2) Vector3 instantiations by spreading the primitive coordinates.
