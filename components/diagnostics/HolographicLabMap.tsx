...
const ConnectionLines = () => {
  // ⚡ Bolt: Memoize the typed array directly and avoid intermediate Vector3 allocations
  // to prevent WebGL buffer reallocation on every render and reduce GC overhead.
