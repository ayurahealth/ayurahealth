...
export default function HolographicLabMap({ results = [] }: Props) {
  ...
  // ⚡ Bolt: Optimize O(N*M) lookup
  // What: Pre-process results array into a Record map
  // Why: Avoids O(N*M) nested lookup when mapping BIOMARKER_MAP against results
  // Impact: Reduces lookup complexity from O(N*M) to O(N)
