...
const ConnectionLines = () => {
  // ⚡ Bolt Optimization: Directly construct Float32Array without intermediate THREE.Vector3
  // objects and fully memoize the args array to prevent WebGL buffer reallocation on every render.
