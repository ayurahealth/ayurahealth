...
const ConnectionLines = () => {
  // Memoize the final Float32Array to prevent WebGL buffer reallocation on every render
  // and construct flat array directly to avoid THREE.Vector3 instantiation overhead
