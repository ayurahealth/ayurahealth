...
const ConnectionLines = () => {
  const positions = useMemo(() => {
    // ⚡ Bolt: Removed intermediate THREE.Vector3 allocations inside the loop
    // and memoize the Float32Array to prevent costly WebGL buffer reallocations on every render.
    const p: number[] = []
