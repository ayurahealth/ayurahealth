...
const ConnectionLines = () => {
  // ⚡ Bolt: Compute and directly memoize the Float32Array to avoid recreating it
  // on every render, which triggers costly WebGL buffer reallocations in bufferAttribute args.
