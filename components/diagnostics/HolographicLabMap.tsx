...
const ConnectionLines = () => {
  // ⚡ Bolt: Memoize the typed array directly and avoid intermediate THREE.Vector3 objects
  // Passing a stable reference to args prevents costly WebGL buffer reallocations on every render.
  const positionArgs = useMemo(() => {
    const p: number[] = []
    ...
    return [new Float32Array(p), 3] as [Float32Array, number]
  }, [])
