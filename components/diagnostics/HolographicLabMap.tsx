...
const ConnectionLines = () => {
  // ⚡ Bolt: Memoize the Float32Array and args tuple to avoid WebGL buffer reallocations on every render.
  // Avoid creating intermediate THREE.Vector3 objects to reduce memory allocation overhead.
