...
const ConnectionLines = () => {
  const points = useMemo(() => {
    // ⚡ Bolt: Prepared flat coordinate array directly from primitive values to minimize object creation overhead. Memoized the Float32Array to pass a stable reference to args, avoiding costly WebGL buffer reallocation on every render.
    const p: number[] = []
