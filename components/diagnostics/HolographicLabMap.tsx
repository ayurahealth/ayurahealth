...
const ConnectionLines = () => {
  // ⚡ Bolt: Memoize the typed array directly to prevent WebGL buffer reallocation on every render,
  // and avoid creating intermediate THREE.Vector3 objects to reduce memory allocation/GC overhead.
