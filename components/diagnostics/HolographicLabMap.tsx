...
const ConnectionLines = () => {
  // ⚡ Bolt: Memoize the exact typed array and args reference to prevent WebGL buffer reallocation on every render,
  // and directly push coordinates into a flat array to avoid intermediate THREE.Vector3 garbage collection overhead.
  const [, args] = useMemo(() => {
    const p = []
    ...
    const arr = new Float32Array(p)
    return [arr, [arr, 3] as [Float32Array, number]]
  }, [])
