...
export default function HolographicLabMap({ results = [] }: Props) {
  ...
  // 💡 What: Pre-process results array into a lookup record
  // 🎯 Why: Prevents an O(N * M) nested loop when mapping over BIOMARKER_MAP
  // 📊 Impact: O(1) lookup during render instead of O(M) .find() on each of N markers
