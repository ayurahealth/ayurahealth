...
const ConnectionLines = () => {
  const positions = useMemo(() => {
    // ⚡ Bolt: Avoid creating intermediate THREE.Vector3 objects inside iteration loops just to extract their components. Pushing primitive coordinate values directly into the array minimizes memory allocation and garbage collection overhead.
    const p: number[] = []
