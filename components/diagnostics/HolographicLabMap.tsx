...
const ConnectionLines = () => {
  // ⚡ Bolt: Memoize the Float32Array directly to prevent costly WebGL buffer reallocations on every render
  // and avoid unnecessary THREE.Vector3 object creations and flatMap operations.
