...
export default function ClinicalMarkdown({ 
  ...
  return (
    <div className={`clinical-markdown clinical-report ${className}`} style={{ '--markdown-accent': doshaColor } as React.CSSProperties}>
      {/* ⚡ Bolt: Extract static components outside to prevent ReactMarkdown from unmounting and remounting the entire DOM tree on every render without inline hooks */}
      <ReactMarkdown 
