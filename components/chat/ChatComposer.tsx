          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0 0.25rem' }}>
            <div style={{ display: 'flex', gap: '0.4rem' }}>
              ...
              <button 
                ...
                aria-label={showLinkInput ? "Hide trace URL input" : "Trace from URL"}
                title={showLinkInput ? "Hide trace URL input" : "Trace from URL"}
                style={{ 
                  width: 36, height: 36, borderRadius: '10px', 
              ...
              {voiceSupported && (
                <button 
                  ...
                  aria-label={isListening ? "Stop voice synthesis" : "Start voice synthesis"}
                  title={isListening ? "Stop voice synthesis" : "Start voice synthesis"}
                  style={{ 
                    width: 36, height: 36, borderRadius: '10px', 
