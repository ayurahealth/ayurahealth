          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0 0.25rem' }}>
            <div style={{ display: 'flex', gap: '0.4rem' }}>
              ...
              <button 
                ...
                aria-label={showLinkInput ? "Hide source link input" : "Add source link"}
                title={showLinkInput ? "Hide source link input" : "Add source link"}
              ...
              {voiceSupported && (
                <button 
                  ...
                  aria-label={isListening ? "Stop voice synthesis" : "Start voice input"}
                  title={isListening ? "Stop voice synthesis" : "Start voice input"}
